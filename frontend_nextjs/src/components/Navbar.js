  ...
  return (
    <nav className='w-full flex justify-between py-4 px-2'>
      ...
      >
        RAG:{" "}
        <span 
          className={`${isRagOn ? "text-accent/60 [text-shadow:_0_0_3px_#f6339a]" : "text-white/60 [text-shadow:_0_0_3px_#fff]"}`}
      ...
      <button
        className="bg-primary text-text-secondary text-lg px-4 py-1 rounded-full cursor-pointer font-medium shadow-sm font-poppins"
      >
        Logout
      </button>
    </nav>
